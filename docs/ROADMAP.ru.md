...
**Успех:** новый исследователь может создать единообразную карточку, не изобретая формат. Фундамент теперь также включает индекс документации, индекс legacy-материалов, детерминированные сгенерированные индексы, validation CI, need-based маршруты, review cadence policy и scheduled monitoring источников/сроков review.
