...
**Успех:** новый исследователь может создать единообразную карточку, не изобретая формат. Фундамент теперь также включает индекс документации, индекс legacy-материалов, детерминированные сгенерированные индексы, validation CI и первый need-based маршрут.
