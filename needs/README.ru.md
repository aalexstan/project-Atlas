...
Начните здесь, если известна задача пользователя, но ещё не выбран API или источник данных.

Needs - это маршруты Atlas вокруг практических задач. Они связывают вопрос пользователя с карточками API, сравнениями, procurement kit и нерешёнными вопросами.
