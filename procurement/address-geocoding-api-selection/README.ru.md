...
| Geoapify Geocoding API | [`provider-request.ru.md`](../../research/geoapify-geocoding-api/provider-request.ru.md) |
| OpenCage Geocoding API | [`provider-request.ru.md`](../../research/opencage-geocoding-api/provider-request.ru.md) |
| LocationIQ Geocoding API | [`provider-request.ru.md`](../../research/locationiq-geocoding-api/provider-request.ru.md) |
...
- Profiles: [`DaData Address APIs`](../../apis/dadata-address-api/README.ru.md), [`Yandex Maps Geosuggest API`](../../apis/yandex-maps-geosuggest-api/README.ru.md), [`Yandex Maps Geocoder API`](../../apis/yandex-maps-geocoder-api/README.ru.md), [`Yandex Maps Organization Search API`](../../apis/yandex-maps-organization-search-api/README.ru.md), [`2GIS Suggest API`](../../apis/2gis-suggest-api/README.ru.md), [`2GIS Places API`](../../apis/2gis-places-api/README.ru.md), [`2GIS Geocoder API`](../../apis/2gis-geocoder-api/README.ru.md), [`Geoapify Geocoding API`](../../apis/geoapify-geocoding-api/README.ru.md), [`OpenCage Geocoding API`](../../apis/opencage-geocoding-api/README.ru.md), [`LocationIQ Geocoding API`](../../apis/locationiq-geocoding-api/README.ru.md), [`Nominatim Geocoder Software`](../../apis/nominatim-geocoder-software/README.ru.md), [`FIAS/GAR Data Integration`](../../apis/fias-gar-data-integration/README.ru.md)
