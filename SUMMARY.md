...
- Legacy dataset note `datasets/procurement_tender_contracts.md` связана с Seldon.Tenders decision memo и оставлена как supporting evidence для будущего procurement/tender API comparison.
