...
- Для FIAS/GAR Data Integration после inspection official `structure-12032021.zip` проверить current 57 GB data ZIP inner contents/checksums/row counts, full/delta package model, API services method catalog, auth, quotas, costs, SMEV eligibility и legal-use rights.
