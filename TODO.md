...
- Для comparison `commerce-operations-integration` получить официальный профиль Ozon Seller API и затем сопоставимые account/plan limits, SLA, rights и synthetic benchmark; не добавлять Ozon в comparison до этого.
