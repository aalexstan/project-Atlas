...
- Для WeatherAPI.com уточнить поведение `current_fields`, fuzzy location matching, plan-specific limits, SLA, storage/redistribution и data rights; не повышать maturity без закрытия findings и независимой проверки.
