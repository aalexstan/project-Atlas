...
- Для FIAS/GAR Data Integration после inspection official `structure-12032021.zip` и current data ZIP central directory проверить XML payload contents, row counts, CRC validation against payload, full/delta package model, API services method catalog, auth, quotas, costs, SMEV eligibility и legal-use rights.
