...
| Current FNS open-data metadata lists GAR/FIAS package `data-28072026-structure-20191024.zip`, last modification `2026-07-28`, actuality date `2026-08-02`, previous release links and methodological recommendations version `4.0`. | https://www.nalog.gov.ru/opendata/7707329152-fias/ | 2026-07-29 | verified | Data archive contents and full/delta semantics were not inspected. |
| Official GAR/FIAS structure archive contains 22 XSD schema files; current data ZIP headers report `application/zip`, `Content-Length: 57170912095` and `Last-Modified: Mon, 27 Jul 2026 17:57:53 GMT`. | https://data.nalog.ru/opendata/7707329152-fias/structure-12032021.zip | 2026-07-29 | verified | Structure archive inspected; data ZIP not downloaded. |
