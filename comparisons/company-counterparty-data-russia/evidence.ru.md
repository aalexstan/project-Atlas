...
Проверено: **2026-07-23**. Addendum по ГЛОБАС.API проверен: **2026-07-28**. Public-page recheck перехода форматов ФНС: **2026-08-05**.
...
| FTS-008A | Официальные публичные страницы ФНС после запланированного перехода всё ещё указывают, что с 01.08.2026 выдача идёт только в форматах ЕГРЮЛ 4.08 и ЕГРИП 4.07 | [Сервис интеграции](https://www.nalog.gov.ru/rn77/service/egrip2/) | verified_public_page_after_cutover | Проверено 2026-08-05; credentialed FTP behavior не тестировался |
