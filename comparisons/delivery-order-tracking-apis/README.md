...
| Integrate contracted CDEK delivery | CDEK Logistics API | Waybills and status synchronisation are described | Technical API details need provider confirmation |
