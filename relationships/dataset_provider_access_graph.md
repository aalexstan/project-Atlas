...
flowchart TD
    ...
    MOSCOW_API --> MOSCOW_DOC_RISK["Документация: data.mos.ru доступна; limits/rights требуют проверки"]
...
| Открытые городские данные Москвы | Правительство Москвы | API и веб-портал | `data.mos.ru`, документация доступна; права и лимиты требуют проверки | бесплатно по API Portal | неизвестно | другие гос. порталы не исследованы |
