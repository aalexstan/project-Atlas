...
The [2026-08-24 bounded public-instance live-test](../../research/nominatim-geocoder-software/live-test-2026-08-24.md) tested three policy-compliant individual geocoding requests. Raw responses exposed OpenStreetMap attribution and ODbL signals; the unknown query returned an empty result. `live_tested` remains `false` until human review sets the validity dates. No import or benchmark was performed.
