...
|---|---|---|---|---|
| 2GIS Search APIs разделяют Geocoder, Places и Suggest. | https://docs.2gis.com/en/api/search/overview | 2026-07-29 | verified | Граница продукта. |
...
| Access key получается в Platform Manager как demo key или subscription. | https://docs.2gis.com/en/api/search/overview | 2026-07-29 | verified | Authentication/onboarding. |
...
| 2GIS заявляет ежемесячное обновление справочника. | https://docs.2gis.com/en/api/search/overview | 2026-07-29 | provider_reported | Не benchmarked Atlas. |
