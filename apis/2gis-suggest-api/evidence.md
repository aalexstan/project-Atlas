...
|---|---|---|---|---|
| 2GIS Search APIs are separated into Geocoder, Places, Suggest and related APIs. | https://docs.2gis.com/en/api/search/suggest/overview | 2026-07-29 | verified | Product boundary evidence. |
...
| Access key comes from Platform Manager as demo key or subscription. | https://docs.2gis.com/en/api/search/suggest/overview | 2026-07-29 | verified | Authentication/onboarding. |
