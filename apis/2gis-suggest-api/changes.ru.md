# История изменений 2GIS Suggest API

[English version](changes.md)

| Дата | Изменение | Evidence |
|---|---|---|
| 2026-07-29 | Создан reviewed API-first профиль 2GIS Suggest API. | [`evidence.ru.md`](evidence.ru.md) |

## Заметки для мониторинга

- Перепроверять тарифы и минимальные пакеты перед закупкой.
