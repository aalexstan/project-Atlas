...
| FNS open-data catalog lists current data ZIP URL and separate structure ZIP URL for the GAR/FIAS dataset. | https://www.nalog.gov.ru/opendata/7707329152-fias/ | 2026-07-29 | verified | Atlas inspected the structure ZIP and current data ZIP central directory; XML payload was not downloaded. |
...
| The current official data ZIP central directory lists 1,739 entries: 1 `version.txt`, 1,738 XML files, 96 regional directories and 11 root-level entries. | https://fias.nalog.ru/opendata/7707329152-fias/data-28072026-structure-20191024.zip | 2026-07-29 | verified | Inspected via HTTP Range; XML payload was not downloaded. |
...
| The current package model remains unknown from metadata, structure XSDs and central directory alone. | https://www.nalog.gov.ru/opendata/7707329152-fias/ | 2026-07-29 | unknown | XML row counts, full/delta semantics and CRC validation against payload remain uninspected. |
...
No credentialed API integration, SMEV access, portal endpoint test or production data archive ingest was performed. Atlas inspected the public structure ZIP, checked HTTP headers for the public data ZIP and parsed the current data ZIP central directory via byte ranges only.
