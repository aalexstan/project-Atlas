...
| Current package model remains unknown from metadata, structure XSDs and central directory alone. | https://www.nalog.gov.ru/opendata/7707329152-fias/ | 2026-07-29 | unknown | XML row counts, full/delta semantics и CRC validation against payload remain uninspected. |
...
Credentialed API integration, SMEV access, portal endpoint test или production data archive ingest не проводились. Atlas inspected public structure ZIP, checked HTTP headers for public data ZIP and parsed current data ZIP central directory via byte ranges only.
