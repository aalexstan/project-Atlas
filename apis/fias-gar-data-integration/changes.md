...
| 2026-07-29 | Decompressed and parsed all XML files in sample regional directory `99/`. | Adds regional payload smoke-test evidence while national row counts, other regions and full/delta semantics remain blockers. |
| 2026-07-29 | Decompressed and parsed all XML files in sample regional directory `87/` and validated CRC/size for the sampled entries. | Adds a second regional payload sample with integrity evidence while national row counts, remaining regions and full/delta semantics remain blockers. |
| 2026-07-29 | Decompressed and parsed sparse sample regional directory `82/` and validated CRC/size for the sampled entries. | Adds an edge-case sample showing valid mostly-empty XML groups while national row counts, remaining regions and full/delta semantics remain blockers. |
